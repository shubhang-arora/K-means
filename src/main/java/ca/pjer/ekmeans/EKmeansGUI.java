...
package main.java.ca.pjer.ekmeans;
...
public class EKmeansGUI {
    ...
    public EKmeansGUI() {
        ...
        csvImportButton.setBorderPainted(true);
        csvImportButton.setBackground(Color.BLACK);
        csvImportButton.setForeground(Color.WHITE);
        ...
        csvExportButton.setBorderPainted(true);
        csvExportButton.setBackground(Color.BLACK);
        csvExportButton.setForeground(Color.WHITE);
        ...
        nTextField.setBackground(Color.GRAY);
        nTextField.setForeground(Color.WHITE);
        ...
        kTextField.setBackground(Color.gray);
      ...
      //  toolBar.add(debugTextField);
        ...
        contentPanel.add(statusBar, BorderLayout.NORTH);
